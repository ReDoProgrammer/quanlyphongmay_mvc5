...
namespace QuanLyPhongMayThucHanh_MVC.Areas.admin.Controllers
{
    public class FacultyController : BaseController
    {
        ...
        public JsonResult Insert(string acronym, string name)
        {
            ...
            return Json(new { code = 500m,icon = "error",header="FAILED", msg = "Can not create new faculty!" }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult Update(int id, string acronym, string name)
        {
            ...
            return Json(new { code = 500, icon = "success", header = "SUCCESSFULLY", msg = "The faculty has been updated!" }, JsonRequestBehavior.AllowGet);
        }
